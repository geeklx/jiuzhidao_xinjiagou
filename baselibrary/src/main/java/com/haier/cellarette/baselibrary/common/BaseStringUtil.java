...
public class BaseStringUtil {
    ...
    /**
     * BaseStringUtil.isEmpty(null) = true BaseStringUtil.isEmpty("") = true
     * BaseStringUtil.isEmpty(" ") = false BaseStringUtil.isEmpty("gaohang") = false
     * BaseStringUtil.isEmpty("  gaohang  ") = false
     */
    // 是否为空
...
//		String regex = "[0-9]{18}";
    ...
    /**
     * BaseStringUtil.isBlank(null) = true BaseStringUtil.isBlank("") = true
     * BaseStringUtil.isBlank(" ") = true BaseStringUtil.isBlank("gaohang") = false
     * BaseStringUtil.isBlank("  gaohang  ") = false
     */
    // 是否为空白
    ...
    /**
     * BaseStringUtil.isNotEmpty(null) = false BaseStringUtil.isNotEmpty("") = false
     * BaseStringUtil.isNotEmpty(" ") = true BaseStringUtil.isNotEmpty("gaohang") = true
     * BaseStringUtil.isNotEmpty("  gaohang  ") = true
     */
    // 是否不为空
    ...
    /**
     * BaseStringUtil.isNotBlank(null) = false BaseStringUtil.isNotBlank("") = false
     * BaseStringUtil.isNotBlank(" ") = false BaseStringUtil.isNotBlank("gaohang") =
     * true BaseStringUtil.isNotBlank("  gaohang  ") = true
     */
    // 是否不为空白
    ...
    /**
     * BaseStringUtil.isNumeric(null) = false BaseStringUtil.isNumeric("") = false
     * BaseStringUtil.isNumeric("  ") = false BaseStringUtil.isNumeric("1234567890") =
     * true BaseStringUtil.isNumeric("12 3") = false BaseStringUtil.isNumeric("ab2c") =
     * false BaseStringUtil.isNumeric("12-3") = false BaseStringUtil.isNumeric("12.3") =
     * false
     */
    // 是否为数字
...
//        BaseMyLogUtil.i("printSerialString", stringBuffer.toString());//by holy
    }


    public static byte getHexByteFrom10(int i) {
        byte b=(byte) Integer.parseInt(Integer.toHexString(i), 16);
//        BaseMyLogUtil.i("testbyte::::", String.format("%02x", b));
        return b;
    }
